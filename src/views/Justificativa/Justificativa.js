...
export default function AtividadeItem(props) {
  ...
  function associadoEdit(e, id = null) {
    ...
    if (id != 0 && id != null) {
      props.history.push({
        pathname: `/console/justificativa/edit/${id}`,
      });
    } else {
      props.history.push({
        pathname: `/console/justificativa/edit/`,
      });
    }
  }
    ...
    <div className="animated fadeIn">
      <Row>
        <Col xs="12" lg="12">
          <Card>
            <CardHeader>
              <i className="fa fa-align-justify"></i> Justificativa
                ...
                <Col>
                  <FormGroup>
                    <InputGroup>
                      ...
                      <Input
                        type="text"
                        placeholder="Consulte a Justificativa..."
                        onChange={(e) => {
