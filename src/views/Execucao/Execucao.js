...
export default function AtividadeItem(props) {
  ...
  function associadoEdit(e, id = null) {
    ...
    if (id != 0 && id != null) {
      props.history.push({
        pathname: `/console/execucao/edit/${id}`,
      });
    } else {
      props.history.push({
        pathname: `/console/execucao/edit/`,
      });
    }
  }
  ...
  function associadoDelete(e, id) {
    e.preventDefault();
    if (window.confirm("Deseja realmente deletar este Execução ?")) {
      deleteAssociado(id);
    }
  }
    ...
    <div className="animated fadeIn">
      <Row>
        <Col xs="12" lg="12">
          <Card>
            <CardHeader>
              <i className="fa fa-align-justify"></i> Execução
              <div className="card-header-actions">
                ...
                >
                  <i className="icon-note" /> Novo Execução
                </Button>
              </div>
            </CardHeader>
            <CardBody>
                ...
                <Col>
                  <FormGroup>
                    <InputGroup>
                      ...
                      <Input
                        type="text"
                        placeholder="Consulte a Execução..."
                        onChange={(e) => {
