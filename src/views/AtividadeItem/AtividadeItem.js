...
export default function AtividadeItem(props) {
  ...
  function associadoEdit(e, id = null) {
    ...
    if (id != 0 && id != null) {
      props.history.push({
        pathname: `/console/atividade_item/edit/${id}`,
      });
    } else {
      props.history.push({
        pathname: `/console/atividade_item/edit/`,
      });
    }
  }
    ...
    <div className="animated fadeIn">
      <Row>
        <Col xs="12" lg="12">
          <Card>
            <CardHeader>
              <i className="fa fa-align-justify"></i> Atividade Item
              <div className="card-header-actions">
                ...
                >
                  <i className="icon-note" /> Novo Atividade Item
                </Button>
              </div>
            </CardHeader>
            <CardBody>
                ...
                <Col>
                  <FormGroup>
                    <InputGroup>
                      ...
                      <Input
                        type="text"
                        placeholder="Consulte a Atividade Item..."
                        onChange={(e) => {
